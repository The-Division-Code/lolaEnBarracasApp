...
module.exports = productsAPIController = {
    ...
    index: (req, res) => {
        ...
        let respuesta = {
            ...
            data: {
                ...
                products_subcategories: 'http://localhost:3030/api/products/products_subcategories',
                products_pictures: 'http://localhost:3030/api/products/products_pictures',
                products_colors: 'http://localhost:3030/api/products/products_colors',
                products_categories: 'http://localhost:3030/api/products/products_categories',
    ...
    productsBySubCat: (req, res) => {
        ...
        db.Products.findAll({where: {subcategory: req.params.subcategory}})
            .then(products => {
                ...
                products.length == 0 ? res.send('No se ha encontrado') : res.json(respuesta);
            })
            .catch(error => {
    ...
    subcategoriesByCatId: (req, res) => {
        ...
        db.Products_Subcategories.findAll({ where: { cat_id: req.params.cat_id } })
            .then(subcategories => {
    ...
    picturesByProdId: (req, res) => {
        ...
        db.Products_Pictures.findAll({ where: { product_id: req.params.product_id } })
